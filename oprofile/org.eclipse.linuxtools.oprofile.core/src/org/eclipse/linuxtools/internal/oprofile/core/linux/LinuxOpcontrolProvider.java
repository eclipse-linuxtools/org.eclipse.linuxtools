...
public class LinuxOpcontrolProvider implements IOpcontrolProvider {
	 ...
	 * @param eventName
	 *            The name of the event containing the session
	 */
	@Override
	 ...
	 * 
	 * @param args
	 *            list of opcontrol command and arguments
	 * @return true if any output was produced on the error stream.
	 *         Unfortunately this appears to currently be the only way we can
	 *         tell if user correctly entered the password
	 */
	 ...
	 *            List of arguments
	 * @param event
	 *            The event to be passed as argument to opcontrol
	 */
	 ...
	 *            List of arguments
	 * @param options
	 *            The launch options to oprofile daemon
	 */
