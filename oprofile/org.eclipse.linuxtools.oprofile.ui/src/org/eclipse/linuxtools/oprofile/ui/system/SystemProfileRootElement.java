...
public abstract class SystemProfileRootElement extends ProfileElement
{
	...
	protected IOpModelContainer _container;
	protected int _count = -1;
	
	SystemProfileRootElement(IProfileElement parent, int type, IOpModelContainer sfile)
	{
		super(parent, type);
		_container = sfile;
	}
	...
	{
		// OpModelSample containers always have children; other samplefiles, symbols or samples
	 	return true;
	}
...
//			IOpModelContainer[] files = _container.getSampleContainers(OprofileUiPlugin.getActiveWorkbenchShell());
//			if (files != null) {
...
//			OpModelSample[] samples = _container.getSamples(null);
//
