...
import com.st.stgprof.utils.Aggregator;
...
public class GprofAggregatorTest extends TestCase {
	...
	public static void testAggregation(String dir) throws Exception {
		File directory = new File (STJunitUtils.getAbsolutePath("com.st.gprof.test", dir));
		File gmonPath = new File (STJunitUtils.getAbsolutePath("com.st.gprof.test", dir+File.separator+GMON_OUTPUT_FILE));
		File binaryPath = new File (STJunitUtils.getAbsolutePath("com.st.gprof.test", dir+File.separator+GMON_BINARY_FILE));
