...
/**
 * This class is on charge of managing "com.st.binutils.crossCompilerBinutils" extension point.
...
public class STBinutilsFactoryManager {
	...
	private ISTBinutilsFactory getBinutilsFactoryImpl(String cpu) {
		try {
			...
			IExtensionPoint ep = reg.getExtensionPoint("com.st.flexperf.binutils.crossCompilerBinutils");
