...
public class CGArc extends AbstractTreeElement {
	...
	/*
	 * (non-Javadoc)
	 * @see com.st.visualprof.stgprof.view.callgraph.CGElement#hasChildren()
	 */
	...
	/* (non-Javadoc)
	 * @see com.st.visualprof.stgprof.view.histogram.AbstractTreeElement#getCalls()
	 */
	@Override
	public int getCalls() {
		return arc.getCount();
	...
	/* (non-Javadoc)
	 * @see com.st.visualprof.stgprof.view.histogram.AbstractTreeElement#getSamples()
	 */
	@Override
