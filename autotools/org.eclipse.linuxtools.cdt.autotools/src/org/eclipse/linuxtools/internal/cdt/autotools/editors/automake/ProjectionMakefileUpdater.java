...
import org.eclipse.linuxtools.cdt.autotools.editors.automake.AutomakeEditorFactory;
...
public class ProjectionMakefileUpdater implements IProjectionListener {
	...
	private class ReconcilerParticipant implements IReconcilingParticipant {
		...
		/* (non-Javadoc)
		 * @see org.eclipse.linuxtools.internal.cdt.autotools.editors.automake.IReconcilingParticipant#reconciled()
		 */
