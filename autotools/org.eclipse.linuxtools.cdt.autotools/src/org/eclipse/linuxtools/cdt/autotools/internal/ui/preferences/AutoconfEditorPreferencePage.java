...
public class AutoconfEditorPreferencePage extends AbstractEditorPreferencePage {
	...
	protected Control createContents(Composite parent) {
		AutotoolsPlugin.getDefault().getWorkbench().getHelpSystem().setHelp(getControl(), IMakeHelpContextIds.MAKE_EDITOR_PREFERENCE_PAGE);
	...
	/* (non-Javadoc)
	 * @see org.eclipse.linuxtools.cdt.autotools.internal.ui.preferences.AbstractAutomakeEditorPreferencePage#handleDefaults()
	 */
