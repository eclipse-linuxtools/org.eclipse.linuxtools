...
public class NewAutotoolsCProjectWizard extends NewCProjectWizard {
	 ...
	 * String constants
	 */
	protected static final String PREFIX = "WizardAutotoolsNewCProject";	//$NON-NLS-1$
	...
	public NewAutotoolsCProjectWizard() {
		this(AutotoolsPlugin.getResourceString(WZ_TITLE), AutotoolsPlugin.getResourceString(WZ_DESC));
	}

	public NewAutotoolsCProjectWizard(String title, String description) {
