...
public class NewAutotoolsCCProjectWizard extends NewCCProjectWizard {

	/* (non-Javadoc)
	 * String constants
	 */
	protected static final String PREFIX = "WizardAutotoolsNewCCProject";	//$NON-NLS-1$
	...
	public NewAutotoolsCCProjectWizard() {
		this(AutotoolsPlugin.getResourceString(WZ_TITLE), AutotoolsPlugin.getResourceString(WZ_DESC));
	}

	public NewAutotoolsCCProjectWizard(String title, String description) {
	...
	protected void addNature(IProgressMonitor monitor) throws CoreException {
		monitor.beginTask("", 4);
		monitor.subTask(AutotoolsPlugin.getResourceString(MSG_ADD_NATURE));
		...
		monitor.subTask(AutotoolsPlugin.getResourceString(MSG_ADD_NATURE));
		AutotoolsProjectNature.addAutotoolsNature(newProject, new SubProgressMonitor(monitor, 1));
		monitor.subTask(AutotoolsPlugin.getResourceString(MSG_ADD_BUILDER));
		AutotoolsProjectNature.addAutotoolsBuilder(newProject, new SubProgressMonitor(monitor, 1));
		monitor.done();
	}
