...
public class RemoteMessages extends NLS {
	private static final String BUNDLE_NAME = "org.eclipse.linuxtools.internal.valgrind.launch.remote.remoteMessages"; //$NON-NLS-1$
	public static String RemoteLaunchDelegate_error_launch_failed;
	public static String RemoteLaunchDelegate_error_no_fs;
	public static String RemoteLaunchDelegate_error_no_peers;
	...
	public static String RemoteTab_error_peer;
	...
	public static String RemoteTab_label_peers;
