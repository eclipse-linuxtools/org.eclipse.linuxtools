...
public class STFindReplaceAction extends ResourceAction implements IUpdate {
    ...
    /**
     * Represents the "global" find/replace dialog. It tracks the active part and retargets the find/replace dialog
     * accordingly. The find/replace target is retrieved from the active part using
     ...
     *            constructor), or <code>null</code> if none
     * @param target
     *            the ISTFindReplaceTarget to use
     * @param shell
     *            the shell
     * @see ResourceAction#ResourceAction(ResourceBundle, String)
     * 
